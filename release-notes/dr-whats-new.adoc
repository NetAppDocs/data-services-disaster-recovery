...
Refer to https://docs.netapp.com/us-en/bluexp-disaster-recovery/get-started/dr-prerequisites.html[NetApp Disaster Recovery prerequisites]. 
...
//For details about setting up licensing for NetApp Disaster Recovery, refer to https://docs.netapp.com/us-en/bluexp-disaster-recovery/get-started/dr-licensing.html[Set up licensing]. 

https://docs.netapp.com/us-en/bluexp-disaster-recovery/get-started/dr-intro.html[Learn more about NetApp Disaster Recovery]. 
...
For details about managing licenses for *all* NetApp Console data services, refer to https://docs.netapp.com/us-en/bluexp-digital-wallet/task-manage-data-services-licenses.html[Manage licenses for all NetApp Console data services^].
...
https://docs.netapp.com/us-en/bluexp-disaster-recovery/get-started/dr-intro.html[Learn about NetApp Disaster Recovery].
...
link:https://docs.netapp.com/us-en/bluexp-disaster-recovery/get-started/dr-intro.html[Learn more about NetApp Disaster Recovery].
