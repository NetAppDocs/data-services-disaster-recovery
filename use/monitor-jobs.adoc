...
[.lead]
Monitor NetApp Disaster Recovery jobs to track their status and progress. 
...
+
[TIP]
When you review job details, NetApp Disaster Recovery shows the user who initiated the job. If the responsible party is listed as "system," NetApp Disaster Recovery initiated the job.  
