...
+
[TIP]
When reviewing job details, Disaster Recovery reports the user who initiated the job. If the field displays "system," this means Disaster Recovery initiated the job. 
