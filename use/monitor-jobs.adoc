...
[.lead]
Monitor NetApp Disaster Recovery jobs to view their history, status, and details. Track job status and progress enables you to catch failed or stalled operations before they affect recovery readiness.
