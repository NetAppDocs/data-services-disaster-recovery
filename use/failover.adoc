...
During a failover test, Disaster Recovery temporarily creates virtual machines. Disaster Recovery maps a temporary datastore backing the FlexClone volume to the ESXi hosts.
