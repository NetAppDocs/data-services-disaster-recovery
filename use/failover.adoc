...
[.lead]
When a disaster or other similar event occurs, use NetApp Disaster Recovery to recover critical workloads so applications can resume at the disaster recovery site with planned mappings.
