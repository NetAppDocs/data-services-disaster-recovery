...
[.lead]
Before you create a disaster recovery plan, add the sites you want to protect in NetApp Disaster Recovery. A site is a collection of vCenter servers or Kubernetes clusters, either on premises or in the cloud. Add both the production site and the disaster recovery site so Disaster Recovery can coordinate the resources used for recovery.
...
+
. In the Settings window, edit the fields as needed.
