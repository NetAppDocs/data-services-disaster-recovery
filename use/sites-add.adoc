...
[.lead]
Before you can create a disaster recovery plan, you need to add sites to Disaster Recovery. A site is a group of Kubernetes or a collection of vCenter servers (on-premises or in the cloud). You should add the primacy or production site and the disaster recovery site.
...
If this is your first time using NetApp Disaster recovery, you need to add vCenter information. If you've already added vCenter information, you see the dashboard.
+
...
--
. In Disaster Recovery, select **Sites** in the sidebar. 
. In the dropdown menu, filter by *Kubernetes* sites.
+
image::site-type-toggle.png[Screenshot of the site type toggle]
. Choose the site you want to add a Kubernetes cluster too. Select the action menu for the site then **Add cluster**.
...
+
image:add-kubernets-cluster.png[Screenshot of Add Kubernetes cluster options.]
