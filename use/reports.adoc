...
Use reports to assess replication compliance and recovery history before an incident so you can identify protection gaps.

[TIP]
link:dashboard-view.html[You can review protection statuses at a high level in the Dashboard or by workload in the Workloads page.]
