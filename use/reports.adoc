...
. Toggle the view to show *Kubernetes* or *VMware*. 
. Select *Create report*.
. Choose the **File type** (PDF, HTML, or JSON) and **Time period** (between the past one and seven days) that the report should cover. Select *Create* to generate the report. 
+
