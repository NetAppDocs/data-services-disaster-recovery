...
If you plan to use platform-managed backups (that is, existing ONTAP snapshots) while creating SnapMirror relationships, it's recommended you use the *MirrorAll* replication policy. 
