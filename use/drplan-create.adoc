...
+
When setting snapshot frequency, the minimum allowed is five minutes. 
...
.. Based on the provider selection, Disaster Recovery populates existing configured cloud subscriptions. Choose the *Subscription*, *Resource group*, and *Storage account* for the cloud provider.
.. Select **Add**. 
+
...
[NOTE]
For Kubernetes, this is the final step for creating a replication. For vCenters, continue to the <<Compute resources section>>.
