...
* *Retain original folder hierarchy*: When selected, Disaster Recovery retains the VM inventory hierarchy (folder structure) on failover. If the recovery target does _not_ have the original folder hierarchy, Disaster Recovery creates.
+
