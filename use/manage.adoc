...
Changing the retention count enables you to increase or decrease the number of snapsohts saved. 
...
. Select **Kubernetes** in the dropdown menu. 
. In the action menu for the site you want to modify, select **Remove cluster**.
. Review the dialog menu then select **Remove from site**. Ensure you pick the correct option to continue Trident Protect operation.  
