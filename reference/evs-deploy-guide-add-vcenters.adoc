...
.. If your company uses an external certificate authority (CA) or the vCenter Endpoint Certificate Store, clear *Use self-signed certificates*. Otherwise, leave the box checked.
