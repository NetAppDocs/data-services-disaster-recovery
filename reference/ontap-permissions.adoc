...
Disaster Recovery requires the following ONTAP permissions:
...
To add permissions in ONTAP, create a role with the required privileges and assign it to a user. You can complete this task in ONTAP with System Manager or the ONTAP CLI. 
