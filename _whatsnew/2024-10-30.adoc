...
=== VM name aliasing
When you create a replication plan, you can now add a prefix and suffix to the VM names on the disaster recovery site. This enables you to use a more descriptive name for the VMs in the plan.
