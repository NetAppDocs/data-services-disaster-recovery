...
For more information, see link:../use/failover.html[Fail over applications].
...
For more information, see link:../reference/switch-console-agents.html[Switch console agents].
