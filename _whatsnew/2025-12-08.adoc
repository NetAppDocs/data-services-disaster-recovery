=== Folder hierarchy retention options
...
For more information, see link:../use/dr-plan-create.adoc[Create a replication plan].
// For more information, see link:https://docs.netapp.com/us-en/data-services-disaster-recovery/use/dr-plan-create.adoc[Create a replication plan].

=== Streamlined Console agent updating process 
...
For more information, see link:../reference/switch-console-agent.html[Switch console agents].
