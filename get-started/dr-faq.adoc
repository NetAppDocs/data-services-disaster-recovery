...
[.lead]
Use this FAQ to find quick answers to common questions about NetApp Disaster Recovery.

*What is the NetApp Disaster Recovery URL?*
In a browser, go to https://console.netapp.com/[https://console.netapp.com/^] to access the NetApp Console. 

*Do I need a license to use NetApp Disaster Recovery?*
...
NetApp Disaster Recovery does not require enablement. It appears automatically in the left navigation of the NetApp Console.  
