...
[.lead]
Learn how to get started quickly with NetApp Disaster Recovery, ensuring your system meets the requirements, discovering workloads, and configuring replication plans to prepare for failover.
...
[role="quick-margin-para"]
After you set up the service, you can complete these next steps. 
