...
[.lead]
Disaster recovery to the cloud is a resilient and cost-effective way of protecting workloads against site outages and data corruption events. NetApp Disaster Recovery is a cloud-based disaster recovery service that automates disaster recovery workflows. With NetApp Disaster Recovery, you can protect your on-premises Kubernetes clusters, NFS-based workloads, and VMware vSphere virtual machine file system (VMFS) datastores for iSCSI and FC running NetApp storage to one of the following: 

* Amazon Elastic VMware Service (EVS) with Amazon FSx for NetApp ONTAP. For details, refer to link:../reference/evs-deploy-guide-introduction.html[Introduction to NetApp Disaster Recovery with Amazon Elastic VMware Service and Amazon FSx for NetApp ONTAP].
* VMware Cloud (VMC) on AWS with Amazon FSx for NetApp ONTAP 
* Azure VMware Solution with NetApp Cloud Volumes ONTAP (iSCSI) (Private preview)
...
image:../use/evs-console-architecture.png[Diagram showing components of the NetApp Disaster Recovery]
...
image:../use/evs-use-cases.png[Diagram showing use cases for NetApp Disaster Recovery]

NOTE: You must configure the vSphere server outside of NetApp Disaster Recovery in vSphere Server. 
...
* Purchase a pay-as-you-go (PAYGO) subscription with the Amazon Web Services (AWS) Marketplace, Azure Marketplace, or Google Cloud Marketplace. This license enables you to purchase a fixed protected capacity license without any long-term commitment.
...
You can try NetApp Disaster Recovery with a 30-day free trial. 

To continue after the 30-day trial, you need to obtain a Pay-as-you-go (PAYGO) subscription from your cloud provider or purchase a BYOL license from NetApp.
...
image:dr-architecture-diagram-70-2.png[Diagram showing architecture of the NetApp Disaster Recovery service infrastructure]
...
Disaster Recovery uses the following components:
