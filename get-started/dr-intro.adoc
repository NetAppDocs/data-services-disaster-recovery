...
// sync with supported infrastructure in dr-setup
...
//image:draas-onprem-to-cloud-onprem.png[Diagram showing components of the NetApp Disaster Recovery]
...
Disaster Recovery uses the following components to provide disaster Recovery workloads:
