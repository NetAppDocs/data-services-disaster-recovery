...
[.lead]
NetApp Disaster Recovery offers several licensing options, including a free trial, a pay-as-you-go subscription, and bring your own license (BYOL). Confirm your licensing model before configuring disaster recovery to ensure the service meets your organizational needs. 
...
link:https://docs.netapp.com/us-en/console-licenses-subscriptions/concept-licenses-subscriptions.html[Learn more about subscriptions^].
...
. Begin by adding primary and disaster recovery sites. 
+
For details, see link:../use/sites-add.html[Add sites].
...
+
Or, from the Disaster Recovery menu, select *View payment methods*. 
+
...
. Use AWS Marketplace or Microsoft Azure Marketplace to subscribe to *NetApp Disaster Recovery*. 
...
+
You can view subscription details in the NetApp Console subscription page. link:https://docs.netapp.com/us-en/console-licenses-subscriptions/task-homepage.html[Learn more managing subscriptions with the NetApp Console^].
...
https://docs.netapp.com/us-en/console-licenses-subscriptions/task-manage-data-services-licenses.html[Learn about adding licenses with the NetApp Console^].



== Update your license when it expires

If your licensed term is nearing the expiration date, or if your licensed capacity is reaching the limit, you'll be notified in the NetApp Disaster Recovery UI. You can update your NetApp Disaster Recovery license before it expires so that there is no interruption in your ability to use the service.

TIP: This message also appears in the NetApp Console and in https://docs.netapp.com/us-en/console-setup-admin/task-monitor-cm-operations.html#monitoring-operations-status-using-the-notification-center[Notifications]. 


https://docs.netapp.com/us-en/console-licenses-subscriptions/task-manage-data-services-licenses.html[Learn about updating licenses with the NetApp Console^].
...
+
This deletes all schedules, replication plans, resource groups, vCenters, Kubernetes clusters, and sites. Audit data, operation logs, and jobs history are retained until the end of the life of the product. 
+
