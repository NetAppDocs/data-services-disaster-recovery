...
[.lead]
NetApp Disaster Recovery offers several licensing options, including a free trial, a pay-as-you-go subscription, and bring your own license (BYOL).
...
+
Or, from the NetApp Disaster Recovery menu, select *View payment methods*. 
+
