...
[.lead]
To use NetApp Disaster Recovery, perform a few steps to set it up both in the NetApp Console and the supported disaster recovery environment environment. 
