...
+
* If you haven't yet added a NetApp Console agent, you'll need to add one. To add the agent, refer to https://docs.netapp.com/us-en/console-setup-admin/concept-connectors.html[Learn about Console agents^].
