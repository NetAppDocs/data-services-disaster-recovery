...
* the Google project with the VMware engine needs to be allow-listed for creating, mount, and unmounting datastores. Contact the Google SRE team for this allow-listing. 
