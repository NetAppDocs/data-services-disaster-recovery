...
* link:task-kubernetes-prerequisites.html[Review the additional requirements for Kubernetes clusters].
...
[IMPORTANT]
Depending on your deployment type, review the link:reference-vmware-prerequisites.html[VMware cluster prerequisites] and link:task-kubernetes-prerequisites.html[Kubernetes cluster prerequisites].
